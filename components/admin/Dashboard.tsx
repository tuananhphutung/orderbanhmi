    ...
    <div className="p-4 md:p-8 pb-24 animate-in fade-in">
      ...
      <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-3xl p-6 text-white shadow-xl mb-8 relative overflow-hidden">
        <div className="relative z-10">
            ...
            {aiResponse && (
                <div className="mt-4 bg-black/20 backdrop-blur-sm rounded-2xl p-4 border border-white/10 animate-in slide-in-from-top-2">
                    <div className="text-indigo-50 whitespace-pre-line text-sm leading-relaxed">
                        {aiResponse}
                    </div>
                </div>
            )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
          <p className="text-gray-400 text-xs font-bold uppercase tracking-wider">Đơn hàng</p>
        ...
        <div className="bg-orange-500 p-6 rounded-3xl shadow-lg text-white">
          <p className="text-orange-100 text-xs font-bold uppercase tracking-wider">Bán chạy nhất</p>
                    ...
                    {orders.slice(0, 10).map(order => (
                        <tr key={order.id} className="hover:bg-gray-50 transition-colors">
                            <td className="px-6 py-4">
                                ...
                                <p className="text-[10px] text-gray-400 uppercase">#{order.id.slice(-4)}</p>
                            </td>
